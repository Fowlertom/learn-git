...
$param1 = $args[0];if ([string]::IsNullOrEmpty($sourceBranch)) { throw "No param1 specified."}
$param2 = $args[1];if ([string]::IsNullOrEmpty($targetBranch)) { throw "No param2 specified."}
